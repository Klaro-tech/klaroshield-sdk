...
Real status as of 2026-08-12. Split by what's ready to ship vs. what
genuinely needs a human decision/action — same discipline as the rest of
this session: don't claim something's launch-ready until it's verified.
...
- [ ] **Decide launch day/time** — PH conventional wisdom is Tue-Thu,
...
- [ ] **GA traffic check before committing a launch slot** — per this
      ...
      of whether the product resonates, not a confirmation it already
      does.
- [ ] **Reddit** — r/programming, r/node, r/artificial (check each
      subreddit's self-promotion rules first, several require an
      established account history) — not drafted yet, lower priority
      than PH/HN per the original 5-workstream brief's own ordering.
- [ ] **YouTube** — not started. Needs a real screen recording, which
      needs the CLI commands actually run on camera — same "real capture"
      standard as the screenshots above.
- [ ] **Actually submit** — none of the above is submitted anywhere yet.
      Drafts and metadata are launch-ready; the human step of clicking
      "submit" on PH/HN and picking the moment is still open.
